...
st.set_page_config(
    page_title="Logistic Regression Algorithm"
)

st.write("""
# Dynamic _Iris flower_ prediction

Based on the user's input, this web app uses a **Logistic Regression Classifier** to predict the Iris flower variety.
